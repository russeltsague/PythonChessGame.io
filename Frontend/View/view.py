...
from chess.Frontend.models import preferenceswindow
from chess.Backend.models import exceptions
from chess.Frontend.controller import  controller
...
class View():
    ...
    # main method responsible for internal functioning of the game.
    def on_square_clicked(self, event):
        ...
        # invoked on second click as on first click selected_piece_position is None.
    ...
    def update_label(self, piece, start_pos, end_pos):
        ...
        self.info_label["text"] = '' + piece.color.capitalize() + "  :  " + start_pos + end_pos + '    ' + turn.capitalize() + '\'s turn'
    ...
    def on_about_menu_clicked(self):
        messagebox.showinfo("Play a Game of Chess!", "May you win the game\n")
